...
public sealed class Test1
{
    ...
    {
        StudentWork student = ParseTextFile.ParseLine(studentString);
        StudentWork trueStudent = new StudentWork(nameTrueStudent, workTrueStudent, DateTime.Parse(dateTrueStudent));
    ...
    {
        var result = ParseTextFile.ParseLine(rawString);
    ...
    public void StudentWorkParsingFromStrings()
    {
        ...
        List<StudentWork> students = ParseTextFile.FileParser(rawStrings);
        StudentWork firststudent = new StudentWork("Bob", "Some work", DateTime.Parse("2012-12-12"));
        StudentWork secondStudent = new StudentWork("Jill", "Forest camp", DateTime.Parse("2023-02-14"));
    ...
    public void LoadObjectsToEmptyList()
    {
        ...
        string[] rawStrings = { "\"Bob\" \"Some work\" 2012-12-12", "  \"Jill\"      \"Forest camp\"             2023-02-14" };
        List<StudentWork> students = ParseTextFile.FileParser(rawStrings);
        ParseTextFile.LoadObjects(students, ref studentWorks, ref isLoad);
    ...
    public void FilterTest1()
    {
        ...
        ObservableCollection<StudentWork> studentWorks1 = ParseTextFile.Filter(studentWorks, "");
    ...
    public void FilterTest2()
    {
        ...
        ObservableCollection<StudentWork> studentWorks1 = ParseTextFile.Filter(studentWorks, "Bob");
    ...
    public void FilterNoMatchesReturnsEmptyCollection()
    {
        ...
        var filtered = ParseTextFile.Filter(studentWorks, "Alice");
